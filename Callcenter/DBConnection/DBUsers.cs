...
namespace Callcenter.DBConnection
{
    ...
    internal partial class Database : IMongoDbContext
    {
        ...
        internal void SendRequestToUsers(string connectionid, ApplicationUser user)
        {
            new Task(() => _hubContext.Clients.Client(connectionid).SendAsync("item", FindRequestForUsers(user)).Wait()).Start();
        }
